...
namespace UnhollowerRuntimeLib
{
    public unsafe static class ClassInjector
    {
        ...
        public static void RegisterTypeInIl2Cpp<T>() where T : class
        {
            ...
            ulong baseptr = (ulong)baseClassPointer.Pointer;

            /*LogSupport.Trace("baseClassPointer: " + baseptr.ToString("x2"));

            Console.WriteLine("baseClassPointer Part1->byval_arg: 0x" + new IntPtr(baseClassPointer.Part1->byval_arg).ToString("x2"));
            Console.WriteLine("baseClassPointer Part1->this_arg: 0x" + new IntPtr(baseClassPointer.Part1->this_arg).ToString("x2"));
            Console.WriteLine("baseClassPointer this_arg->data: 0x" + baseClassPointer.Part1->this_arg->data.ToString("x2"));
            Console.WriteLine("baseClassPointer byval_arg->data: 0x" + baseClassPointer.Part1->byval_arg->data.ToString("x2"));
            Console.WriteLine("baseClassPointer this_arg->type: 0x" + baseClassPointer.Part1->this_arg->type.ToString("x"));
            Console.WriteLine("baseClassPointer byval_arg->type: 0x" + baseClassPointer.Part1->byval_arg->type.ToString("x"));*/
            ...
            classPointer.Part1->element_class = classPointer.Part1->castClass = classPointer.ClassPointer;
            ...
            *classPointer.Bitfield1 = ClassBitfield1.initialized | ClassBitfield1.size_inited | ClassBitfield1.has_finalize;
            *classPointer.Bitfield2 = ClassBitfield2.is_vtable_initialized;
            ...
            /*Console.WriteLine("Part1->byval_arg: 0x" + new IntPtr(classPointer.Part1->byval_arg).ToString("x2"));
            Console.WriteLine("Part1->this_arg: 0x" + new IntPtr(classPointer.Part1->this_arg).ToString("x2"));
            Console.WriteLine("this_arg->data: 0x" + classPointer.Part1->this_arg->data.ToString("x2"));
            Console.WriteLine("byval_arg->data: 0x" + classPointer.Part1->byval_arg->data.ToString("x2"));
            Console.WriteLine("this_arg->type: 0x" + classPointer.Part1->this_arg->type.ToString("x"));
            Console.WriteLine("byval_arg->type: 0x" + classPointer.Part1->byval_arg->type.ToString("x"));*/
