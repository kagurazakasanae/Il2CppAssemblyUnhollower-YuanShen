...
namespace UnhollowerBaseLib.Runtime.VersionSpecific
{
    public class Unity2018_4NativeClassStructHandler : INativeClassStructHandler
    {
        ...
        private unsafe class Unity2018_4NativeClassStruct : INativeClassStruct
        {
            ...
            public byte* typeHierarchyDepth => &((Il2CppClassU2018_4*)Pointer)->typeHierarchyDepth;
            public byte* genericRecursionDepth => &((Il2CppClassU2018_4*)Pointer)->genericRecursionDepth;
            public byte* rank => &((Il2CppClassU2018_4*)Pointer)->rank;
            public byte* minimumAlignment => &((Il2CppClassU2018_4*)Pointer)->minimumAlignment;
            public byte* packingSize => &((Il2CppClassU2018_4*)Pointer)->packingSize;
