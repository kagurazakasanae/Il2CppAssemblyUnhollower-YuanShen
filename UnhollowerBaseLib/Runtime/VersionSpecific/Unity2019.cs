...
namespace UnhollowerBaseLib.Runtime.VersionSpecific
{
    public class Unity2019NativeClassStructHandler : INativeClassStructHandler
    {
        ...
        private unsafe class Unity2019NativeClassStruct : INativeClassStruct
        {
            ...
            public byte* typeHierarchyDepth => &((Il2CppClassU2019*)Pointer)->typeHierarchyDepth;
            public byte* genericRecursionDepth => &((Il2CppClassU2019*)Pointer)->genericRecursionDepth;
            public byte* rank => &((Il2CppClassU2019*)Pointer)->rank;
            public byte* minimumAlignment => &((Il2CppClassU2019*)Pointer)->minimumAlignment;
            public byte* packingSize => &((Il2CppClassU2019*)Pointer)->packingSize;
